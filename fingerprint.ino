...
const char *ssid = "Dialog 4G D23"; //ENTER YOUR WIFI SETTINGS
const char *password = "Ff4NbTdL";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.8.104/biometricattendance/getdata.php"; //computer IP or the server domain
